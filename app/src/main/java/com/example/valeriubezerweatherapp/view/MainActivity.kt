package com.example.valeriubezerweatherapp.view
...
import com.example.valeriubezerweatherapp.R
import com.example.valeriubezerweatherapp.viewmodel.MainViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var cName = GET.getString("cityName", "chisinau")?.toLowerCase()
